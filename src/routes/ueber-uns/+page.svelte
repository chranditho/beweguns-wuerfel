<script lang="ts">
	...
	let conny = {
		...
		altText: 'Auf den Foto sieht man Cornelia Thonhauser aka Conny aka Lia, die als Psychologin und Trainerin im Team ist.',
	...
	let flo = {
		imageSrc: floImgSrc,
		altText: 'Auf den Foto sieht man Flora Bodingbauer aka Flo, die frische Perspektiven aus der Waldorfschule ins Team bringt.',
	...
	let sam = {
		imageSrc: samImgSrc,
		altText: 'Auf den Foto sieht man Samuel Grausgruber aka Samu, der Ideengeber für das Projekt des BewegUNS-Würfels.',
	...
	let chrisi = {
		...
		altText: 'Auf den Foto sieht man Christoph Thonhauser aka Chrisi, der für die Website-Entwicklung zuständig ist.',
