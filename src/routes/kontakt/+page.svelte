...
<div class="max-w-6xl mx-auto">
		...
		<div>
			<section>
				...
				<form on:submit|preventDefault={handleSubmit} class="space-y-4">
					...
					{#if submitMessage}
						<div class="mt-4 p-4 rounded-md {submitMessage.includes('erfolgreich') ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'}">
							{submitMessage}
						</div>
					{/if}
				</form>
	...
	<div class="mt-8 text-sm text-gray-600">
		<p><strong>Hinweis:</strong> Die in eckigen Klammern stehenden Platzhalter sind durch die entsprechenden aktuellen Kontaktdaten zu ersetzen.</p>
	</div>
</div>